...
/*
 *  渲染showDetail页面的 左测 中间  折线图
 * */
@WebServlet("/client/GetDealServlet")
public class GetDealServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<GoldEntity> dealList = gs.getDeal(howRow, goldVariety);
		 String jsonString = JSON.toJSONString(dealList);
